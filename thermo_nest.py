...
# version 0.3 2015-12-    Adding reading of Nest as another probe
#-------------------------------------------------------------------------
...
query_db("""INSERT INTO PiTemp (date, sonde1, sonde2, sonde3, sonde4) VALUES ('%s','%s','%s','%s','%s')
         """ % (datebuff, sonde_value[0], sonde_value[1], sonde_value[2], sonde_value[3]))
